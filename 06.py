...
for group in input.split("\n\n"):
    members = [set(people) for people in group.split("\n")]

    part1.append(len(members[0].union(*members[0:])))
    part2.append(len(members[0].intersection(*members[0:])))
